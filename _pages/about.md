...
<div style="margin:10px 0; padding:8px; background:#f8f9fa; border-radius:6px;">
  <div style="display:flex; justify-content:space-between; gap:10px;">
    <img src="images/research1-1.png" alt="1-1" style="width:49%; height:auto; border-radius:4px;">
    <img src="images/research1-2.png" alt="1-2" style="width:49%; height:auto; border-radius:4px;">
  </div>
...
<div style="margin:10px 0; padding:8px; background:#f8f9fa; border-radius:6px;">
  <div style="display:flex; justify-content:space-between; gap:10px;">
    <img src="images/research1-3.png" alt="1-3" style="width:49%; height:auto; border-radius:4px;">
    <img src="images/research1-4.png" alt="1-4" style="width:49%; height:auto; border-radius:4px;">
  </div>
...
<div style="margin:10px 0; padding:8px; background:#f8f9fa; border-radius:6px;">
  <div style="display:flex; justify-content:space-between; gap:10px;">
    <img src="images/research1-5.png" alt="1-5" style="width:49%; height:auto; border-radius:4px;">
    <img src="images/research1-6.png" alt="1-6" style="width:49%; height:auto; border-radius:4px;">
  </div>
...
<div style="margin:10px 0; padding:8px; background:#f8f9fa; border-radius:6px;">
  <div style="display:flex; justify-content:space-between; gap:10px;">
    <img src="images/research2-1.png" alt="2-1" style="width:49%; height:auto; border-radius:4px;">
    <img src="images/research2-2.png" alt="2-2" style="width:49%; height:auto; border-radius:4px;">
  </div>
...
<div style="margin:10px 0; padding:8px; background:#f8f9fa; border-radius:6px;">
  <div style="display:flex; justify-content:space-between; gap:10px;">
    <img src="images/research2-3.png" alt="2-3" style="width:49%; height:auto; border-radius:4px;">
    <img src="images/research2-4.png" alt="2-4" style="width:49%; height:auto; border-radius:4px;">
  </div>
...
<div style="margin:10px 0; padding:8px; background:#f8f9fa; border-radius:6px;">
  <div style="display:flex; justify-content:space-between; gap:10px;">
    <img src="images/research2-5.png" alt="2-5" style="width:49%; height:auto; border-radius:4px;">
    <img src="images/research2-6.png" alt="2-6" style="width:49%; height:auto; border-radius:4px;">
  </div>
...
<div style="margin:10px 0; padding:8px; background:#f8f9fa; border-radius:6px;">
  <div style="display:flex; justify-content:space-between; gap:10px;">
    <img src="images/research3-1.png" alt="3-1" style="width:100%; height:auto; border-radius:4px;">
</div>   
...
<div style="margin:10px 0; padding:8px; background:#f8f9fa; border-radius:6px;">
  <div style="display:flex; justify-content:space-between; gap:10px;">
    <img src="images/research3-2.png" alt="3-2" style="width:49%; height:auto; border-radius:4px;">
    <img src="images/research3-3.png" alt="3-3" style="width:49%; height:auto; border-radius:4px;">
  </div>
...
<div style="margin:10px 0; padding:8px; background:#f8f9fa; border-radius:6px;">
  <div style="display:flex; justify-content:space-between; gap:10px;">
    <img src="images/research3-4.png" alt="3-4" style="width:49%; height:auto; border-radius:4px;">
    <img src="images/research3-5.png" alt="3-5" style="width:49%; height:auto; border-radius:4px;">
  </div>
...
- **地址**：上海市，上海大学机电工程与自动化学院/无人艇工程研究院/未来技术学院
